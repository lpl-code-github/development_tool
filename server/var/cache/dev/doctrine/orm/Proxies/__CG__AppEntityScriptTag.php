 ...
 */
class ScriptTag extends \App\Entity\ScriptTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\ScriptTag' . "\0" . 'id', '' . "\0" . 'App\\Entity\\ScriptTag' . "\0" . 'script', '' . "\0" . 'App\\Entity\\ScriptTag' . "\0" . 'tag'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ScriptTag $proxy) {
