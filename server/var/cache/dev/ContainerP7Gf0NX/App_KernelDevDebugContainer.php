...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Functional\\FileController' => 'getFileControllerService',
            'App\\Controller\\Functional\\GeneratorController' => 'getGeneratorControllerService',
            'App\\Controller\\Functional\\NewmanController' => 'getNewmanControllerService',
            'App\\Controller\\Functional\\RiskIdController' => 'getRiskIdControllerService',
            'App\\Controller\\Functional\\ScriptController' => 'getScriptControllerService',
            'App\\Controller\\Functional\\SystemController' => 'getSystemControllerService',
            'App\\Controller\\Resource\\DatabaseBackupController' => 'getDatabaseBackupControllerService',
            'App\\Controller\\Resource\\NewmanTasksController' => 'getNewmanTasksControllerService',
            'App\\Controller\\Resource\\OperationLogController' => 'getOperationLogControllerService',
            'App\\Controller\\Resource\\ScriptsController' => 'getScriptsControllerService',
            'App\\Controller\\Resource\\TagController' => 'getTagControllerService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/LogSubscriber.php';
            include_once \dirname(__DIR__, 4).'/src/Factory/OperationLogFactory.php';
            include_once \dirname(__DIR__, 4).'/src/Service/OperationLogService.php';
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\DatabaseBackupRepository' => ['privates', 'App\\Repository\\DatabaseBackupRepository', 'getDatabaseBackupRepositoryService', true],
            'App\\Repository\\NewmanTaskRepository' => ['privates', 'App\\Repository\\NewmanTaskRepository', 'getNewmanTaskRepositoryService', true],
            'App\\Repository\\OperationLogRepository' => ['privates', 'App\\Repository\\OperationLogRepository', 'getOperationLogRepositoryService', true],
            'App\\Repository\\ScriptRepository' => ['privates', 'App\\Repository\\ScriptRepository', 'getScriptRepositoryService', true],
            'App\\Repository\\ScriptTagRepository' => ['privates', 'App\\Repository\\ScriptTagRepository', 'getScriptTagRepositoryService', true],
        ...
        $a->addCustomNumericFunction('IFNULL', 'DoctrineExtensions\\Query\\Mysql\\IfNull');
    ...
    protected function getEventDispatcherService()
    {
        ...
        }, 1 => 'onKernelRequest'], 999);
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\CorsSubscriber'] ?? ($this->privates['App\\EventSubscriber\\CorsSubscriber'] = new \App\EventSubscriber\CorsSubscriber()));
        }, 1 => 'onKernelResponse'], 999);
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\ExceptionSubscriber'] ?? ($this->privates['App\\EventSubscriber\\ExceptionSubscriber'] = new \App\EventSubscriber\ExceptionSubscriber(($this->services['kernel'] ?? $this->get('kernel', 1)))));
        }, 1 => 'onKernelException'], 800);
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\LogSubscriber'] ?? $this->getLogSubscriberService());
        }, 1 => 'onKernelResponse'], 700);
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\LogSubscriber'] ?? $this->getLogSubscriberService());
        }, 1 => 'onKernelException'], 900);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private 'App\EventSubscriber\LogSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\LogSubscriber
     */
    protected function getLogSubscriberService()
    {
        $a = ($this->privates['App\\Service\\OperationLogService'] ?? $this->getOperationLogServiceService());

        return $this->privates['App\\EventSubscriber\\LogSubscriber'] = new \App\EventSubscriber\LogSubscriber(new \App\Factory\OperationLogFactory($a), $a);
    }

    /**
     * Gets the private 'App\Service\OperationLogService' shared autowired service.
     *
     * @return \App\Service\OperationLogService
     */
    protected function getOperationLogServiceService()
    {
        return $this->privates['App\\Service\\OperationLogService'] = new \App\Service\OperationLogService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CP9ZFHLXCW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'top5_ps_command' => 'top -bn 1 | head -n 12 | tail -n +7 | grep -vE \'top|free|awk\'',
            'memory_usage_command' => 'free | awk \'NR==2{printf "%.2f", $3*100/$2 }\'',
            'riskid_code_path' => (\dirname(__DIR__, 5).'/r1/'),
            'riskid_env_path' => (\dirname(__DIR__, 5).'/r1/.env'),
            'riskid_exception_subscriber_php_path' => (\dirname(__DIR__, 5).'/r1/src/EventSubscriber/ExceptionSubscriber.php'),
            'source_test_controller_path' => '/resource/PostmanTestController.php',
            'target_test_controller_path' => (\dirname(__DIR__, 5).'/r1/src/Controller/PostmanTestController.php'),
            'risk_id_entity_path' => (\dirname(__DIR__, 5).'/r1/src/Entity/'),
            'risk_id_controller_path' => (\dirname(__DIR__, 5).'/r1/src/Controller/'),
